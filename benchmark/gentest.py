...
def etl_pipeline(input_strings, extract_workers, transform_workers, load_workers, output_file):
    try:
        # Step 1: Extract
        ...
        with open(output_file, 'w'):
            pass
        etl_pipeline(input_strings, extract_workers, transform_workers, load_workers, output_file)
